...
class TestCore(unittest.TestCase):
    ...
    def test_is_constant_species(self):
        ...
        is_constant, run_results = wc_test.SubmodelDynamicsTestCase().is_constant_species(model_path=self.model_path,
    ...
    def test_is_constant_reactions(self):
        ...
        target_specie_ids = ['RNA_1[c]','RNA_2[c]','RNA_3[c]','RNA_4[c]','RNA_5[c]']
        is_constant, run_results = wc_test.SubmodelDynamicsTestCase().is_constant_reactions(model_path=self.model_path, end_time=600, checkpoint_period=10,
    ...
    def test_scan_reactions(self):
        ...
        final_concentrations = wc_test.SubmodelDynamicsTestCase().scan_reactions(self.model_path, 900, 10, ['transcription_RNA_1'], 'RNA_1[c]', k_cat_vector)
    ...
    def test_scan_species(self):
        ...
        final_concentrations = wc_test.SubmodelDynamicsTestCase().scan_species(self.model_path, 900, 10, ['RNA_4[c]'], 'RNA_4[c]', init_concentrations)
        self.assertGreater(final_concentrations[1], final_concentrations[0])
        self.assertGreater(final_concentrations[2], final_concentrations[1])
        self.assertGreater(final_concentrations[3], final_concentrations[2])
        self.assertGreater(final_concentrations[4], final_concentrations[3])
